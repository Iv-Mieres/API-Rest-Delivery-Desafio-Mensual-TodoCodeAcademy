package com.desafio_mensual2.delivery.controller.exceptions;
...
import com.desafio_mensual2.delivery.model.exceptions.ErrorDetails;
...
public class ControllExceptionsAdvice {
	...
	public ResponseEntity<ErrorDetails> unauthorizedException(HttpSession session) {
		Cliente user = (Cliente) session.getAttribute("usersession");	
		ErrorDetails errorMj = new ErrorDetails();
